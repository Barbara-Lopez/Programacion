...
public class VPrincipal extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(tfNum, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void tfNumActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNumActionPerformed
        try{
            Pattern p=Pattern.compile("^[1-4]{1}$");
            Matcher m=p.matcher(tfNum.getText());
            if(m.matches()){
               int num = Integer.parseInt(tfNum.getText());
               Ejercicio1.seleccion(num);
               if(tfNum.getText().equals("4"))
                    Ejercicio1.terminar();
               else{
                   tfNum.setText(""); 
                    Ejercicio1.vpersona(); 
